...
<div style="width: 100%; background-color: #eff0f0;height: 70px; margin: 0 auto;">
    <img src="image/topLogo.jpg" alt="logo" onclick="location.href='index.jsp'">
</div>
<div class="regist">
    <div class="regist_center">
        <div class="regist_top">
            ...
            <div class="right fr">
                <a href="index.jsp" target="_black">华为官网</a>
            </div>
            <div class="clear"></div>
        ...
        <div style="width: 200px;margin: 50px auto 30px; text-align: center">
            <p style="color: #191919; font-size: 20px">欢迎注册华为账号</p>
            <p style="color: #7d7d7d; font-size: 12px">注册即表示您已阅读并同意华为用户协议</p>
            <p>已有账号,<a href="login.jsp" style="color: #007cfd">去登录></a></p>
        </div>

        <div class="center-block" style="margin-top: 50px; margin-left: 150px">
            <form class="form-horizontal" action="UserServlet?method=register" method="post" style="width: 800px">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <p class="text-danger"><span id="helpBlock" class="help-block ">没有第三个性别了</span></p>
                    </div>
                </div>
                <hr>
                <div class="form-group">
